...
const JSONFileList = {
  'WAUWeekByWeek': 'WAU_week_by_week.json',
  'lastWeekWAUByCity': 'last_week_WAU_by_city.json',
  'regUserCategory': 'reg_user_category.json',
  'contentType': 'content_type.json',
  'lastWeekWAUByHour': 'last_week_WAU_by_hour.json',
  'contentUsageByMonth': 'content_usage_by_month.json',
  'regUserByMonth': 'reg_user_by_month.json',
  'regUserByCity':'reg_user_by_city.json',
}
...
const totalRegUserCnt = regUserCategory.reduce((total, obj) => total + obj.count, 0);
